...
\setbeamerfont{title}{series=\mdseries, parent=structure, size=\Large}
\setbeamerfont{frametitle}{series=\mdseries, parent=structure, size=\Large}
\captionsetup{font=scriptsize, labelfont={bf, scriptsize}}
\setbeamertemplate{itemize items}{\tiny$\bullet$}

% For narrower banner
\makeatletter \setlength{\metropolis@frametitle@padding}{1.5ex} \makeatother
...
\begin{frame}{An Image}
  ...
  $E = mc^2$
  $$ E = mc^2 $$
  Here's my paper \citep{lui2020bayesian}
\end{frame}
