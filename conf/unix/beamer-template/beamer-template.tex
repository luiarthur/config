...
% NOTE: If Fira Sans is installed, comment these lines.
\setbeamerfont{title}{parent=structure, series=\mdseries}
\setbeamerfont{frametitle}{series=\mdseries, parent=structure, size=\Large}
\setbeamertemplate{itemize items}{
  % \tiny\raise2.0pt\hbox{\donotcoloroutermaths$\blacktriangleright$}
  \color{gray}
